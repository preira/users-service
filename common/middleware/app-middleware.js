...
module.exports = async function (app) {
    ...
    //TODO: configuration needs to easier to find and to use in CI/CD pattern
    try {
        ...
        //const authization = await require('../../../authization-module/authization')
            .setup({ app, db: middlewareConfig.db2, rbac_opts: middlewareConfig.rbac_opts,https: false, strategies: middlewareConfig.local_strategies});
